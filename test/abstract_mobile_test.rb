...
class AbstractMobileTest < Test::Unit::TestCase
  ...
  define_method('test: EMOBILEのアドレスからキャリアを取得する') do
    carrier = Jpmobile::Email.carrier_by_email("aaaaa.aaaa@emnet.ne.jp")
    assert_equal(Jpmobile::Mobile::Emobile, carrier.class)
  end
